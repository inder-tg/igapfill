...
#' registered during the same year. This argument can be obtained by using \code{\link[igapfill]{getListFiles}}
#' accordingly. \code{lon} and \code{lat} can be obtained with the functions \code{\link[igapfill]{get_LON}}
